...
-- 테이블 데이터 world.city:~4,188 rows (대략적) 내보내기
...
INSERT INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES
	('ABW', 'Aruba', 'North America', 'Caribbean', 193.00, NULL, 103000, 78.4, 2000.00, 793.00, 'Aruba', 'Nonmetropolitan Territory of The Netherlands', 'Beatrix', 129, 'AW'),
	...
	('USA', 'United States', 'North America', 'North America', 9363520.00, 1776, 278357000, 77.1, 2300.00, 8110900.00, 'United States', 'Federal Republic', 'George W. Bush', 3813, 'US'),
