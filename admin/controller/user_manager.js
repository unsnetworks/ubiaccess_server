 ...
 * create
 *
 * POST http://host:port/manager/user
 */
 
var createUser = function(req, res) {
	logger.debug('createUser 호출됨.');
    logger.debug('요청 패스 -> /manager/user POST');
	...
	try {
        ...
        if (database_mysql.pool) {
            ...
            logger.debug('database_mysql.local_user 객체의 create 메소드 호출');
            database_mysql.local_user.create(database_mysql.pool, data, function(err, result) {
 ...
 * read
 *
 * GET http://host:port/manager/user/:id
 */
 
var readUser = function(req, res) {
	logger.debug('readUser 호출됨 -> /manager/user/:id GET');
	...
	try {
        ...
        if (database_mysql.pool) {
            ...
            database_mysql.local_user.read(database_mysql.pool, data, function(err, result) {
                // 에러 발생 시 - 클라이언트로 에러 전송
                if (err) {
 ...
 * search
 *
 * GET http://host:port/manager/user?criteria
 */
 
var searchUser = function(req, res) {
	logger.debug('searchUser 호출됨.');
    logger.debug('요청 패스 -> /manager/user?criteria GET');
	...
	try {
        ...
        if (database_mysql.pool) {
            ...
            database_mysql.local_user.search(database_mysql.pool, paramColumnNames, page, perPage, data, function(err, rows) {
                // 에러 발생 시 - 클라이언트로 에러 전송
                if (err) {
 ...
 * update
 *
 * PUT http://host:port/manager/user/:id?criteria
 */
 
var updateUser = function(req, res) {
	logger.debug('updateUser 호출됨.');
    logger.debug('요청 패스 -> /manager/user/:id?criteria PUT');
	...
	try {
        ...
        if (database_mysql.pool) {
            ...
            database_mysql.local_user.update(database_mysql.pool, data, function(err, result) {
                // 에러 발생 시 - 클라이언트로 에러 전송
                if (err) {
 ...
 * delete
 *
 * DELETE http://host:port/manager/user/:id
 */
 
var deleteUser = function(req, res) {
	logger.debug('deleteUser 호출됨.');
    logger.debug('요청 패스 -> /manager/user/:id DELETE');
	...
	try {
        ...
        if (database_mysql.pool) {
            ...
            database_mysql.local_user.delete(database_mysql.pool, data, function(err, result) {
                // 에러 발생 시 - 클라이언트로 에러 전송
                if (err) {
